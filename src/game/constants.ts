...
export const FUEL_REBATE_BASE = 4;
export const FUEL_REBATE_SCALE = 1;
export const FUEL_REBATE_CHAIN_CAP = 6;
export const OD_GAIN_BASE = 8;
export const OD_GAIN_SCALE = 2;
export const OD_GAIN_CHAIN_CAP = 10;
